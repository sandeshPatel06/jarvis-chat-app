    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy_last_seen', models.CharField(choices=[('everyone', 'Everyone'), ('contacts', 'My Contacts'), ('nobody', 'Nobody')], default='everyone', max_length=20)),
                ('privacy_profile_photo', models.CharField(choices=[('everyone', 'Everyone'), ('contacts', 'My Contacts'), ('nobody', 'Nobody')], default='everyone', max_length=20)),
                ('privacy_read_receipts', models.BooleanField(default=True)),
                ('privacy_disappearing_messages_timer', models.IntegerField(default=0)),
                ...
                ('chat_wallpaper', models.CharField(blank=True, max_length=500, null=True)),
                ('app_language', models.CharField(default='en', max_length=10)),
